...
<div class="jumbotron ml-5 mr-5 mt-2 mb-0 bg-transparent">
    ...
    <h3 class=" multicolortext"> Alumini Page</h3>
    <h2 id="mua">Meet Your Alumini</h2>
    </div>
...
<form action="backend/login.php" method="POST">
  ...
  <div class="form-group mb-4 ">
    ...
    <input type="password" name="password" class="form-control boxes" minlength="8" placeholder="Password" required>
  ...
  <br>
  <div class="mb-4">
  <button type="submit" id="sub" name="submit" class="btn btn-outline-light "  disabled="disabled">Login</button>
  <button type="button" name="signup" class="eat btn btn-outline-light "><a href="backend/signup.php">Signup</a></button>
</div>
